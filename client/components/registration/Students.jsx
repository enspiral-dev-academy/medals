...
class Students extends React.Component {
  ...
  render () {
    const {fullname, cohort, email, username, password, confirm, showMatch, match} = this.state
    ...
    return (
      <form>
        ...
        <div className='field'>
          <label htmlFor='cohort' className='label'>Cohort name</label>
          <div className='control has-icons-left'>
            <input id='cohort' className='input' name='cohort'
              placeholder='cohort' onChange={this.handleChange} value={cohort} />
            <span className='icon is-small is-left'>
